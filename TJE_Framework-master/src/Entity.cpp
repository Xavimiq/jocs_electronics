...
void EntityPlayer::render() {
	...
	{
		eye = getGlobalMatrix() * Vector3(0.f, 11.f, 0.5f);
		center = eye + front;
	}
	else {
		eye = getGlobalMatrix() * Vector3(0.f, 22.f, 0.5f);
		center = eye + front;
	}
...
//void EntityPrisoner::talkwithplayer(Texture* texture) 
//{
//	EntityGUIelement* DialogueImage;
//	DialogueImage = new EntityGUIelement()
//}