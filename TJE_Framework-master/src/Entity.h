...
public:
	...
	EntityPrisoner(std::string name, Vector3 pos, Mesh* mesh, Shader* shader, Texture* texture, Texture* texture_dialogue, EntityPlayer* player);
...
public:
	...
	EntityItem(std::string name, Vector3 pos, Mesh* mesh, Shader* shader, Texture* texture, EntityPlayer* player) :
		EntityMesh(nullptr, name, mesh, texture, shader, pos) {
		this->player = player;
	}
