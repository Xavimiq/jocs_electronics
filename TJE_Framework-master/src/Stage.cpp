...
PlayStage::PlayStage() : Stage() 
{
	...
	texture_enemy->load("data/Animations/Walking_2/textures/ely-vanguardsoldier-kerwinatienza_diffuse.png", true);
	...
	prisoner_1 = new EntityPrisoner("pris1", Vector3(-210, 0, -95), mesh_prisoner, shader_enemy, texture_dialogue, texture_dialogue, my_player);
	World::get_instance()->root.addChild(prisoner_1);
	
	prisoner_2 = new EntityPrisoner("pris2", Vector3(531, 0, -155), mesh_prisoner, shader_enemy, texture_dialogue, texture_dialogue, my_player);
	prisoner_2->model.rotate(180 * DEG2RAD, Vector3(0, 1, 0));
	World::get_instance()->root.addChild(prisoner_2);

	prisoner_3 = new EntityPrisoner("pris3", Vector3(925, 0, -277), mesh_prisoner, shader_enemy, texture_dialogue, texture_dialogue, my_player);
	...
	Wine1 = new EntityItem("wine", Vector3(-225, 0, -474), mesh_wine, shader_wine, texture_wine, my_player);
	...
	Burguer1 = new EntityItem("burguer", Vector3(678, 0, 585), mesh_burguer, shader_wine, texture_wine, my_player);
