...
PlayStage::PlayStage() : Stage() 
{
	...
	texture_enemy->load("data/Animations/Walking/textures/Ch35_1003_Diffuse.png", true);
	...
	waypoints1.push_back(Vector3(258, 0, 194));
	waypoints1.push_back(Vector3(258, 0, 640));
	waypoints1.push_back(Vector3(401, 0, 640));
	waypoints1.push_back(Vector3(394, 0, 709));
	waypoints1.push_back(Vector3(184, 0, 720));
	waypoints1.push_back(Vector3(184, 0, 189));

	my_enemy_1 = new EntityEnemy("ene1", Vector3(258, 0, 194), mesh_enemy, shader_enemy, texture_enemy, waypoints1, my_player);
	World::get_instance()->root.addChild(my_enemy_1);
	my_enemy_1->cull = false;
	my_enemy_1->model.scale(0.18, 0.18, 0.18);

	std::vector<Vector3> waypoints2;
	waypoints2.push_back(Vector3(-161, 0, -261));
	waypoints2.push_back(Vector3(-144, 0, -288));
	waypoints2.push_back(Vector3(-259, 0, -296));
	waypoints2.push_back(Vector3(-258, 0, -263));
	waypoints2.push_back(Vector3(-161, 0, -261));


	my_enemy_2 = new EntityEnemy("ene2", Vector3(-161, 0, -261), mesh_enemy, shader_enemy, texture_enemy, waypoints2, my_player);
	World::get_instance()->root.addChild(my_enemy_2);
	my_enemy_2->cull = false;
	my_enemy_2->model.scale(0.18, 0.18, 0.18);

	std::vector<Vector3> waypoints3;
	waypoints3.push_back(Vector3(900, 0, 45));
	waypoints3.push_back(Vector3(507, 0, 83));
	waypoints3.push_back(Vector3(507, 0, 420));


	my_enemy_3 = new EntityEnemy("ene3", Vector3(900, 0, 45), mesh_enemy, shader_enemy, texture_enemy, waypoints3, my_player);
	World::get_instance()->root.addChild(my_enemy_3);
	my_enemy_3->cull = false;
	my_enemy_3->model.scale(0.18, 0.18, 0.18);

	std::vector<Vector3> waypoints4;
	waypoints4.push_back(Vector3(794, 0, 645));
	waypoints4.push_back(Vector3(776, 0, 883));
	waypoints4.push_back(Vector3(539, 0, 905));


	my_enemy_4 = new EntityEnemy("ene4", Vector3(794, 0, 645), mesh_enemy, shader_enemy, texture_enemy, waypoints4, my_player);
	World::get_instance()->root.addChild(my_enemy_4);
	my_enemy_4->cull = false;
	my_enemy_4->model.scale(0.18, 0.18, 0.18);

	std::vector<Vector3> waypoints5;
	waypoints5.push_back(Vector3(1063, 0, 896));
	waypoints5.push_back(Vector3(936, 0, 870));
	waypoints5.push_back(Vector3(901, 0, 670));
	waypoints5.push_back(Vector3(980, 0, 662));

	my_enemy_5 = new EntityEnemy("ene5", Vector3(794, 0, 645), mesh_enemy, shader_enemy, texture_enemy, waypoints5, my_player);
	World::get_instance()->root.addChild(my_enemy_5);
	my_enemy_5->cull = false;
	my_enemy_5->model.scale(0.18, 0.18, 0.18);
	...
	prisoner_1 = new EntityPrisoner("pris1", Vector3(-210, 0, -95), mesh_prisoner, shader_enemy, texture_dialogue, texture_dialogue, my_player, 2);
	World::get_instance()->root.addChild(prisoner_1);

	prisoner_2 = new EntityPrisoner("pris2", Vector3(531, 0, -155), mesh_prisoner, shader_enemy, texture_dialogue, Texture::Get("data/PlayStage/Prisoner/Dialogue2_true.png"), my_player, 0);
	prisoner_2->model.rotate(180 * DEG2RAD, Vector3(0, 1, 0));
	World::get_instance()->root.addChild(prisoner_2);

	prisoner_3 = new EntityPrisoner("pris3", Vector3(925, 0, -277), mesh_prisoner, shader_enemy, texture_dialogue, Texture::Get("data/PlayStage/Prisoner/Dialogue3_true.png"), my_player, 1);
	...
	key1 = new EntityKey(Vector3(-91, 0, 437), Door1);
	...
	key3 = new EntityKey(Vector3(1234, 0, 670), Door3);
	World::get_instance()->root.addChild(key3);

	Door4 = new EntityDoor(Vector3(868, 0, 117));
	Door4->model.rotate(90 * DEG2RAD, Vector3(0, 1, 0));
	World::get_instance()->root.addChild(Door4);
	key4 = new EntityKey(Vector3(620, 0, 580), Door4);
	World::get_instance()->root.addChild(key4);

	Door5 = new EntityDoor(Vector3(896, 0, 583));
	Door5->model.rotate(90 * DEG2RAD, Vector3(0, 1, 0));
	World::get_instance()->root.addChild(Door5);
	key5 = new EntityKey(Vector3(766, 0, 402), Door5);
	World::get_instance()->root.addChild(key5);

	//TIMER DOOR
	std::vector<Vector3> area;
	area.push_back(Vector3(149, 0, 516));
	area.push_back(Vector3(-234, 0, 362));


	ButtonDoor0 = new EntityButtonDoor(Vector3(301, 20, 435), Vector3(152, 0, 421), 15.0f, my_player, area);
	World::get_instance()->root.addChild(ButtonDoor0);
	World::get_instance()->root.addChild(ButtonDoor0->Door);

	std::vector<Vector3> area1;
	area1.push_back(Vector3(149, 0, 355));
	area1.push_back(Vector3(-238, 0, 152));

	ButtonDoor1 = new EntityButtonDoor(Vector3(300, 20, 231), Vector3(152, 0, 226), 15.0f, my_player, area1);
	World::get_instance()->root.addChild(ButtonDoor1);
	World::get_instance()->root.addChild(ButtonDoor1->Door);
	
	std::vector<Vector3> area2;
	area2.push_back(Vector3(35, 0 ,-421));
	area2.push_back(Vector3(-275, 0, -541));
	
	ButtonDoor2 = new EntityButtonDoor(Vector3(-105, 20, -416), Vector3(-58, 0, -418), 10.0f, my_player, area2);
	...
	area3.push_back(Vector3(840, 0, 437));
	area3.push_back(Vector3(697, 0, 120));

	ButtonDoor3 = new EntityButtonDoor(Vector3(847, 20, 190), Vector3(844, 0, 237), 10.0f, my_player, area3);
	...
	std::vector<Vector3> area4;
	area4.push_back(Vector3(1341, 0, 940));
	area4.push_back(Vector3(1102, 0, 661));

	ButtonDoor4 = new EntityButtonDoor(Vector3(1097, 20, 847), Vector3(1103, 0, 890), 25.0f, my_player, area3);
	World::get_instance()->root.addChild(ButtonDoor4);
	World::get_instance()->root.addChild(ButtonDoor4->Door);

	//ITEMS
	Mesh* mesh_wine;
	mesh_wine = Mesh::Get("data/PlayStage/objects/wine.obj");

	Texture* texture_wine;
	texture_wine = new Texture();
	texture_wine->load("data/PlayStage/Prisoner/Dialogue1.png");
	Shader* shader_wine;
	shader_wine = Shader::Get("data/shaders/basic.vs", "data/shaders/basic_color.fs");

	Wine1 = new EntityItem("wine", Vector3(-225, 0, -474), mesh_wine, shader_wine, texture_wine, my_player, 1);
	Wine1->model.scale(3, 3, 3);
	World::get_instance()->root.addChild(Wine1);
	
	Mesh* mesh_burguer;
	mesh_burguer = Mesh::Get("data/PlayStage/objects/burguer.obj");

	Burguer1 = new EntityItem("burguer", Vector3(678, 0, 585), mesh_burguer, shader_wine, texture_wine, my_player, 0);
	World::get_instance()->root.addChild(Burguer1);

	Bus = new EntityMesh(NULL, "ent", Mesh::Get("data/PlayStage/objects/Bus.obj"), Texture::Get("data/PlayStage/Prisoner/Dialogue2_true.png"), Shader::Get("data/shaders/basic.vs", "data/shaders/basic_color.fs"), Vector3(1515, 0, 140));
	World::get_instance()->root.addChild(Bus);
	Bus->model.scale(100, 100, 100);
	Cama = new EntityMesh(NULL, "ent", Mesh::Get("data/PlayStage/objects/cama.obj"), Texture::Get("data/PlayStage/Prisoner/Dialogue2_true.png"), Shader::Get("data/shaders/basic.vs", "data/shaders/basic_color.fs"), Vector3(-253, 0, 125));
	World::get_instance()->root.addChild(Cama);
	Cama->model.scale(20, 20, 20);
	Cama->model.rotate(180*DEG2RAD, Vector3(0,1,0));
}
...
void PlayStage::render()
{
	...
	if (World::get_instance()->currentMessageGUI != nullptr) { 
		World::get_instance()->currentMessageGUI->render(); }

	//World::get_instance()->root.render();
...
void PlayStage::update(float seconds_elapsed)
{
	...
	key3->collectKey(my_player);
	key4->collectKey(my_player);
	key5->collectKey(my_player);

	ButtonDoor0->OpenDoor(seconds_elapsed);
	ButtonDoor1->OpenDoor(seconds_elapsed);
	ButtonDoor2->OpenDoor(seconds_elapsed);
	ButtonDoor3->OpenDoor(seconds_elapsed);
	ButtonDoor4->OpenDoor(seconds_elapsed);
	
	ButtonDoor0->clickBotton();
	ButtonDoor1->clickBotton();
	ButtonDoor2->clickBotton();
	ButtonDoor3->clickBotton();
	ButtonDoor4->clickBotton();
}
...
LostStage::LostStage() : WinStage() {
	...
	titleButton = new EntityGUIelement(
		Vector2(width / 2, height/2),
		Vector2(800, 600),
		Texture::Get("data/PlayStage/GameOver.png"),
		eButtonId::NoButton,
		"entGUI"
	);
